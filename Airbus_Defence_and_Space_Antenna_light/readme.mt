...
For the Airbus Defence and Space Antenna Challenge:
...
2. You need to execute:
    ...
    4.. To check the structure of Autoencoder, launch "convlstm_autoencoder.py" ( bash$ python convlstm_autoencoder.py ).
